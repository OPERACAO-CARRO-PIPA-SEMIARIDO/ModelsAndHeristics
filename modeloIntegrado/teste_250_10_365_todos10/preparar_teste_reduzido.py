...
TEST_DIR = REPO_ROOT / "modeloIntegrado" / "teste_250_10_365_todos10"

NUM_BENEFICIARIOS = 250
NUM_MANANCIAIS = 10
NUM_DIAS = 365
...
SCRIPT_MINPICOS = TEST_DIR / "minimizaPicos_250_365_p00.jl"
SCRIPT_M2 = TEST_DIR / "m2_minpicos_250_10.jl"
SCRIPT_MODELO_INTEGRADO = TEST_DIR / "modeloIntegrado_ws_250_10_72h.jl"
...
def main():
    ...
    print("=== Etapa 5: modelo integrado com todos os 10 mananciais ===")
