...
const TOTAL_BENEFICIARIOS = 250
const TOTAL_MANANCIAIS = 10
const TOTAL_DIAS = 365
const NUM_CANDIDATOS = length(ARGS) >= 5 ? parse(Int, ARGS[5]) : TOTAL_MANANCIAIS
...
output_dir = length(ARGS) >= 1 ? ARGS[1] : "resultados_250_10_365_72h"
...
println("Num candidatos:          $NUM_CANDIDATOS")
